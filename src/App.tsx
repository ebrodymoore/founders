...
const GolfTournamentSystem = () => {
  ...
  const schedule: Record<string, ScheduleEvent[]> = {
    'MAY': [
      { date: 'May 15–22', name: 'PGA Championship', type: 'Major' },
      { date: 'May 15', name: 'Supr Club #1', type: 'SUPR', venue: 'Outdoor' },
      { date: 'May 25–31', name: 'Indoor Tournament', type: 'Tour Event' },
      { date: 'May 29', name: 'League Night #1', type: 'League Night' }
    ],
    'JUNE': [
  ...
  const processTournamentUpload = async (data: { players: any[], uploadData: any }) => {
    ...
    try {
      ...
      console.log('🔍 Raw players data before processing:', players);
      ...
      const processedPlayers = players.filter((player) => {
        ...
        if (tournamentData.format === 'Points') {
          ...
          const hasPoints = (grossPoints !== null && grossPoints !== undefined && grossPoints !== '') || 
                           (netPoints !== null && netPoints !== undefined && netPoints !== '');
          
          console.log('🎯 Points format filter check:', {
